...
OceanDemo::OceanDemo() : AppBase() {}

bool OceanDemo::InitScene() {
    ...
    {
        auto mesh = GeometryGenerator::MakeSquare(30.0, {10.0f, 10.0f});
...
void OceanDemo::UpdateLights(float dt) { AppBase::UpdateLights(dt); }

void OceanDemo::Update(float dt) { AppBase::Update(dt); }
